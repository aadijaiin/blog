        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            ...
            <div className="relative min-w-45">
              <select className="w-full pl-4 pr-10 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all appearance-none cursor-pointer">
